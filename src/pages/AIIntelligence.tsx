    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative h-screen flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-br from-black/70 via-black/50 to-secondary/30" />
        </div>
        ...
        <div className="container relative z-10 px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
            {[
              ...
              <motion.div key={i} className="p-8 bg-gradient-to-br from-secondary/10 to-secondary/5 border border-secondary/20 hover:border-secondary/40 transition-all duration-500" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} whileHover={{ y: -10 }}>
            ...
            {[
              ...
              <motion.div key={i} className="group relative" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }}>
                <div className="relative h-80 overflow-hidden mb-6">
                  ...
                  <motion.div className="absolute top-6 right-6 w-16 h-16 bg-secondary/90 backdrop-blur-sm flex items-center justify-center" whileHover={{ rotate: 360 }}>
        ...
        <div className="container relative z-10 px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            {["TensorFlow", "PyTorch", "Kubernetes", "Docker", "Python", "CUDA", "OpenCV", "Scikit-learn", "Apache Spark", "Redis", "PostgreSQL", "MongoDB"].map((tech, i) => (
              <motion.div key={i} className="p-6 bg-gradient-to-br from-secondary/10 to-secondary/5 border border-secondary/20 hover:border-secondary/40 transition-all duration-300" initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ delay: i * 0.05 }} whileHover={{ scale: 1.05, y: -5 }}>
